<template>
  <div
    class="cus-border-color flex h-[700px] w-full flex-col items-center justify-start rounded-xl border-1 p-10 hover:shadow-xl"
  >
    <div class="flex w-full items-start justify-center rounded-xl p-10">
      <div class="pr-10">
