package cn.happain.module.xinyong.module.jiaoyiLink.domain.dto;
...
public class JiaoyiLinkDto extends PageDto implements Serializable  {
    ...
    private String tx;
    @NotNull(message="关联交易不能为空",groups = {})
